...
//import images
import logoSm from "../assets/images/logo-sm-ECI-Networks.png";
import logoDark from "../assets/images/logo-sm-ECI-Networks.png";
import logoLight from "../assets/images/logo-sm-ECI-Networks.png";
...
import SettingModel from "../Components/Common/SettingModel";
                ...
                <div id="scrollbar">
                  <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                      ...
                      <li class="nav-item">
                        <Link class="nav-link menu-link" to="/devices">
                          <i class="ri-calendar-event-fill"></i>
                          <span data-key="t-apps">Devices</span>
                        </Link>
                      </li>
                      <li class="nav-item">
                        <Link class="nav-link menu-link" to="/events">
                          <i class="ri-calendar-event-fill"></i>
