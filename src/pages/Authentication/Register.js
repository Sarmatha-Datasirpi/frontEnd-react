...
const Register = () => {
    ...
    document.title = "Basic SignUp | DPB-NMS - React Admin & Dashboard Template";
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">Regisger Dashboard </p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your free Packet Broker account now</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-2">
                                                    ...
                                                    <select name="role" className="form-select" id="t-status" data-choices data-choices-search-false aria-label="Default select example"
                                                    onChange={validation.handleChange}
                                                    onBlur={validation.handleBlur}
                                                    ...
                                                    {validation.touched.role && validation.errors.role ? (
                                                        <FormFeedback type="invalid"><div>{validation.errors.role}</div></FormFeedback>
                                                    ) : null}
                                                </div>

                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Packet Broker &nbsp;
